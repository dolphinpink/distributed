...
public class ResourceManagerTCP implements ResourceManager {

	private static final int CUSTOMER_PORT = 1043;
	protected RMHashtable m_itemHT = new RMHashtable();

	public ResourceManagerTCP() throws RemoteException {
	}
	...
	// reserve an item
	protected boolean reserveItem(int id, int customerId, String key, int price) {
        ...
        if ( customer == null ) {
            ...
            Trace.warn("RM::reserveitem( " + id + ", " + customerId + ", " + key + ")  failed--customer doesn't exist" );
            return false;

        } else {

			customer.reserve( key, key, price);
...
//    }
	...
	*/
	...
	public boolean reserveCar(int id, int customerId, String location) throws RemoteException {
		return reserveItem(id, customerId, "c" + location, 0);
	}

	// Adds room reservation to this customer.
	public boolean reserveRoom(int id, int customerId, String location) throws RemoteException {
		return reserveItem(id, customerId, "r" + location, 0);
	}
	// Adds flight reservation to this customer.
	public boolean reserveFlight(int id, int customerId, int flightNum) throws RemoteException {
		return reserveItem(id, customerId, "f" + String.valueOf(flightNum), 10);
	}
